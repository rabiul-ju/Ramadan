...
public class R3Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sehri =getString(R.string.sehri_dhaka13);
        ifter = getString(R.string.ifter_dhaka13);
        dhaka_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri=getString(R.string.sehri_sylhet13);
        ifter = getString(R.string.ifter_sylhet13);
        sylhet_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_borishal13);
        ifter = getString(R.string.ifter_borishal13);
        borishal_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_chittagong13);
        ifter = getString(R.string.ifter_chittagong13);
        chittogong_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_dinajpur13);
        ifter = getString(R.string.ifter_dinajpur13);
        dinajpur_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_khulna13);
        ifter = getString(R.string.ifter_khulna13);
        khulna_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_rajshahi13);
        ifter = getString(R.string.ifter_rajshahi13);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_r3, menu);
        return true;
    }
