...
public class M1Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sehri =getString(R.string.sehri_dhaka1);
        ifter = getString(R.string.ifter_dhaka1);
        dhaka_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri=getString(R.string.sehri_sylhet1);
        ifter = getString(R.string.ifter_sylhet1);
        sylhet_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_borishal1);
        ifter = getString(R.string.ifter_borishal1);
        borishal_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_chittagong1);
        ifter = getString(R.string.ifter_chittagong1);
        chittogong_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_dinajpur1);
        ifter = getString(R.string.ifter_dinajpur1);
        dinajpur_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_khulna1);
        ifter = getString(R.string.ifter_khulna1);
        khulna_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_rajshahi1);
        ifter = getString(R.string.ifter_rajshahi1);
