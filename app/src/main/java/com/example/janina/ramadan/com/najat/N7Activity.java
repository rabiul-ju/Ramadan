...
public class N7Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sehri =getString(R.string.sehri_dhaka27);
        ifter = getString(R.string.ifter_dhaka27);
        dhaka_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri=getString(R.string.sehri_sylhet27);
        ifter = getString(R.string.ifter_sylhet27);
        sylhet_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_borishal27);
        ifter = getString(R.string.ifter_borishal27);
        borishal_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_chittagong27);
        ifter = getString(R.string.ifter_chittagong27);
        chittogong_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_dinajpur27);
        ifter = getString(R.string.ifter_dinajpur27);
        dinajpur_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_khulna27);
        ifter = getString(R.string.ifter_khulna27);
        khulna_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_rajshahi27);
        ifter = getString(R.string.ifter_rajshahi27);
