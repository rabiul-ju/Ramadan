...
public class M8Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sehri =getString(R.string.sehri_dhaka8);
        ifter = getString(R.string.ifter_dhaka8);
        dhaka_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri=getString(R.string.sehri_sylhet8);
        ifter = getString(R.string.ifter_sylhet8);
        sylhet_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_borishal8);
        ifter = getString(R.string.ifter_borishal8);
        borishal_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_chittagong8);
        ifter = getString(R.string.ifter_chittagong8);
        chittogong_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_dinajpur8);
        ifter = getString(R.string.ifter_dinajpur8);
        dinajpur_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_khulna8);
        ifter = getString(R.string.ifter_khulna8);
        khulna_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_rajshahi8);
        ifter = getString(R.string.ifter_rajshahi8);
