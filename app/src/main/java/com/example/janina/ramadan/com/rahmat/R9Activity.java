...
public class R9Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sehri =getString(R.string.sehri_dhaka19);
        ifter = getString(R.string.ifter_dhaka19);
        dhaka_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri=getString(R.string.sehri_sylhet19);
        ifter = getString(R.string.ifter_sylhet19);
        sylhet_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_borishal19);
        ifter = getString(R.string.ifter_borishal19);
        borishal_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_chittagong19);
        ifter = getString(R.string.ifter_chittagong19);
        chittogong_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_dinajpur19);
        ifter = getString(R.string.ifter_dinajpur19);
        dinajpur_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_khulna19);
        ifter = getString(R.string.ifter_khulna19);
        khulna_time.setText("\n\t"+sehri + "\n\t"+ifter+"\n");

        sehri = getString(R.string.sehri_rajshahi19);
        ifter = getString(R.string.ifter_rajshahi19);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_r9, menu);
        return true;
    }
